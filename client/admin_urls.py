...
path('service_center/view/', views.service_center_view, name='service_center_view'),
path('service_center/manager/', views.cervice_center_manager, name='service_center_manager'),
]